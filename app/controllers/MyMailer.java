...
// */
//public class MyMailer implements LocalVariablesSupport {
//
...
//                        message.setContent(multipart);//Talvez so colocar no final
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
...
//                            multipart.addBodyPart(bodyPart);
//
//                            //Se nao der certo, tentar esta outra forma de anexar
...
//                    Address[] adresses = {new InternetAddress(replyTo.toString())};
