...
public class UsernamePasswordController extends Controller {
    ...
    private static final String SECURESOCIAL_USER_EMAIL_TAKEN = "securesocial.userEmailTaken";
    ...
    private static final String SECURESOCIAL_INVALID_EMAIL = "securesocial.invalidEmail";
    private static final String SECURESOCIAL_PASSWORDMATCH = "securesocial.passwordsMustMatch";
     ...
     * @param passwordConfirm The password verification
     */
    public static void createAccount(@Required(message = "securesocial.required") String userName,
        ...
        if (UserService.find(email) != null) {
            validation.addError(EMAIL, Messages.get(SECURESOCIAL_USER_EMAIL_TAKEN));
            tryAgain(userName, displayName, email);
        }
        ...
        try {
            ...
            flash.error(Messages.get(SECURESOCIAL_ERROR_CREATING_ACCOUNT + e.getMessage()));
            tryAgain(userName, displayName, email);
        }
